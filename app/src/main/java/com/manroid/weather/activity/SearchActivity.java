...
import com.manroid.weather.model.CitySearch;
import com.manroid.weather.utils.CityParser;
...
public class SearchActivity extends AppCompatActivity {
    ...
    private void loadLastFoundCity() {
        if (mCites.isEmpty()) {
            String lastCity = mCityPref.getString(APP_SETTINGS_CITY, "Ha Dong");
            String lastCountry = mCityPref.getString(APP_SETTINGS_COUNTRY_CODE, "VN");
            String lastLat = mCityPref.getString(APP_SETTINGS_LATITUDE, "20.98");
            String lastLon = mCityPref.getString(APP_SETTINGS_LONGITUDE, "105.79");
